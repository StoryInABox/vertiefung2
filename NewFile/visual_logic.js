...
addHTMLElement('img', 'button', 'TO', ['CONTAINER'], false);
createCSSRule('#button', ('width:100px;' + '\n' +
'height:100px;' + '\n' +
'cursor:pointer;' + '\n' +
...
operateAnimation('PLAY', getAnimations(['ALL_OBJECTS']), null, null, 'AUTO', 1,
        function() {}, false);
...
operateAnimation('PAUSE', getAnimations(['ALL_OBJECTS']), null, null, 'AUTO', 1,
    ...
    eventHTMLElem('click', ['QUERYSELECTOR', '#button'], false, function(event) {
  if (playstate == false) {
    console.log(playstate);

    operateAnimation('RESUME', getAnimations(['ALL_OBJECTS']), null, null, 'AUTO', 1,
            function() {}, false);
